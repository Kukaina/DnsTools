...
<script setup>
  ...
  const themeState = ref(null);
  if (settings.theme && settings.theme.name == "dark") {
    themeState.value = true;
  }
  console.log(settings.theme == darkTheme);
  const changeTheme = () => {
    settings.theme = themeState.value === true ? darkTheme : null;
  };
</script>
...
<style lang="scss" scoped>
  ...
  .theme-switch__clouds {
    ...
    box-shadow: 0.937em 0.312em $clouds-color, -0.312em -0.312em $back-clouds-color,
      1.437em 0.375em $clouds-color, 0.5em -0.125em $back-clouds-color, 2.187em 0 $clouds-color,
      1.25em -0.062em $back-clouds-color, 2.937em 0.312em $clouds-color,
      2em -0.312em $back-clouds-color, 2.187em -0.062em $clouds-color,
      3.625em -0.062em $clouds-color, 2.625em 0em $back-clouds-color, 4.5em -0.312em $clouds-color,
      3.375em -0.437em $back-clouds-color, 4.625em -1.75em 0 0.437em $clouds-color,
      4em -0.625em $back-clouds-color, 4.125em -2.125em 0 0.437em $back-clouds-color;
    transition: $transition;
  }
